              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="space-y-3">
                  ...
                  <div className="relative rounded-xl overflow-hidden border" style={{borderColor: 'var(--border-primary)', aspectRatio: '16/9'}}>
                    <img 
                      src="https://ohbrdgolasejewtcbojt.supabase.co/storage/v1/object/public/website/before.png" 
                ...
                <div className="space-y-3">
                  ...
                  <div className="relative rounded-xl overflow-hidden border" style={{borderColor: 'var(--border-primary)', aspectRatio: '16/9'}}>
                    <img 
                      src="https://ohbrdgolasejewtcbojt.supabase.co/storage/v1/object/public/website/after.png"
                      alt="After thumbnail"
