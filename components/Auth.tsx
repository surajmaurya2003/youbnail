      ...
      <div className="card p-8 w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="text-sm" style={{color: 'var(--text-secondary)'}}>
            {isSignUp ? 'Sign up to start creating thumbnails' : 'Sign in to your account'}
          </p>
        </div>
        ...
        <div className="flex mb-6 p-1 rounded-lg" style={{background: 'var(--bg-secondary)'}}>
          <button
            ...
            className={`flex-1 py-2 px-4 rounded-md text-sm font-medium transition-all ${
              !isSignUp ? 'text-white shadow-sm' : 'text-gray-500'
            }`}
            style={{
        ...
        {/* Magic Link Form */}
        <form onSubmit={handleMagicLinkAuth} className="mb-4">
          <div className="mb-4">
