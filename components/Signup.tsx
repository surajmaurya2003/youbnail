          ...
          <div className="flex items-center justify-between">
            ...
            <nav className="hidden md:flex items-center gap-2">
              <div className="flex items-center gap-1 rounded-full px-1 py-1 backdrop-blur-xl" 
                ...
                <Link to="/login" className="ml-1 px-3 py-2 text-sm font-medium transition-colors rounded-full hover:bg-white/5" style={{color: 'var(--text-secondary)'}}>
                  Login
                </Link>
              </div>
            </nav>
      ...
      <div className="flex-1 flex items-center justify-center pt-20 pb-12 px-4">
        ...
        <div className="text-center mb-8">
          <div className="w-16 h-16 rounded-lg flex items-center justify-center font-semibold text-white mx-auto mb-4" 
            ...
            <img 
              src="https://ohbrdgolasejewtcbojt.supabase.co/storage/v1/object/public/website/youbnail%20favicon.png" 
              alt="Youbnail" 
              className="w-10 h-10"
            />
          </div>
          ...
          <p className="text-sm" style={{color: 'var(--text-secondary)'}}>
            Sign up to start creating thumbnails
          </p>
        </div>
        ...
        {/* Magic Link Form */}
        <form onSubmit={handleMagicLinkSignup} className="mb-4">
          <div className="mb-4">
